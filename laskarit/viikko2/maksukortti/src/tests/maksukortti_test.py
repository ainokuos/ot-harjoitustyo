...
class TestMaksukortti(unittest.TestCase):
	...
	def test_kortin_saldo_ei_ylita_maksumiarvoa(self):
	...
	def test_negatiivnen_lauatus_ei_muuta_saldoa(self):
		self.kortti.lataa_rahaa(-5)
		self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

	def test_voi_ostaa_edullisen_lounaan_oikein(self):
		self.kortti.syo_edullisesti()
		self.kortti.syo_edullisesti()
		self.kortti.syo_edullisesti()
		self.kortti.syo_edullisesti()
	...
	def test_voi_ostaa_maukkaan_lounaan_oikein(self):
		self.kortti.syo_maukkaasti()
		self.kortti.syo_maukkaasti()
